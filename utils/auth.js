    ...
    try {
        ...
        if(response.resultcode){
            ...
            let registrations = [
                ...
                { uname: 'Juniorpro', expe: '17,000', sys: 'UGX', profit: '687,546', curbal: '121,454', welcome: '3,000', totalwith: '566,032', trivia: '17,630', youtube: '16,470', tiktok: '19,824', spin: '31,432'},
